...
//       children: [
//         WLimitGraph(
//           endValue: (consumptionLimit ?? 0) > 0 ? consumptionLimit! : 100,
...
class _WaterConState extends State<WaterCon> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        WLimitGraph(
          //this is what makes the graph doubled, I added this to fix the error that I encounter during compiling.
          endValue: (consumptionLimit ?? 0) > 0 ? consumptionLimit! : 100,
          currentValue: double.tryParse(_controller.text) ?? 0,
          // this is where the editing ended
        ),
        Text(
          "Water Consumption Limit",
          style: GoogleFonts.quicksand(
